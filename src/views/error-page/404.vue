<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops">{{ $t('error.pageLost') }}!</div>
        <div class="bullshit__headline">{{ $t('error.warn404') }}</div>
        <div class="bullshit__info">{{ $t('error.tip404') }}</div>
        <a href="" class="bullshit__return-home">{{ $t('common.backToHome') }}</a>
      </div>
    </div>
  </div>
</template>
